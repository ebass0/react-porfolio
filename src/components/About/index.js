...
const About = () => {
    return (
        <div className='About'>
            ...
            <p className='About-text'>On a mission to become a full-stack developer, I'm constantly expanding my knowledge through different programming languages. My current focus is on JavaScript (ES6), HTML, CSS, React, SQL. I bring a passion for creating engaging and accessible digital experiences, and I'm eager to translate my learning into real-world impact. Looking for opportunities to achieve valuable experience and contribute to meaningful projects.</p>
            <p id='experience'>When I'm not at the computer, I'm usually reading a good book, spending time with friends, hitting the gym for a workout, or binge-watching series, anime, or movies on TV.</p>
        </div>
    );
}
