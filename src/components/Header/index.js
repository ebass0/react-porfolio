        ...
        <div className='main'>
            <header className='informations'>
                <div>
                    ...
                    <h2 className='informations-subtitle'>Web Developer</h2>
                    <p className='informations-text'>Aspiring web developer with a keen eye for detail, I create immersive and user-friendly digital interfaces.</p>
                </div>
                <div>
